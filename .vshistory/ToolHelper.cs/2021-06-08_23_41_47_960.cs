...
namespace CameraOperatorMod.Tool
{
    public static class ToolHelper
    {
        ...
        public static UIButton AddButton<T>(ref UIPanel page, string label, string tooltip, int? labelPadding = null, int? indentPadding = null, Color32? color = null)
        {
            //var font = FontStore.Get(11);

            var pane = Helper.AddButton(ref page, label, tooltip, Helper.Padding(0, 0, 2, 0), color: color);
            return pane;
        }
    }
}

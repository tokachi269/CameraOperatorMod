	...
	public class CameraOperatorToolBase : CameraOperator
	{
		...
		public void Awake()
        {
...

			{
				...
				tabStrip.relativePosition = new Vector2(0, -HeaderHeight);
				Debug.Log("tabStrip initialized");
				tabStrip.tabPages = AddUIComponent<UITabContainer>();

				var container = tabStrip.tabContainer;
				container.relativePosition = new Vector2(0, - HeaderHeight - TabStripHeight);
				...
				{
					{
						...
						btn.relativePosition = new Vector2(0, -TabStripHeight);
						btn.text = v.tab.name;

...
namespace CameraOperatorMod.GUI
{
    public static class Helper
    {
        ...
        public static UIButton AddButton(ref UIPanel parent, string label, string tooltip, bool initialValue, PropertyChangedEventHandler<bool> onCheckChanged)
        {
            var button = parent.AddUIComponent<UIButton>();
            button.anchor = UIAnchorStyle.Top | UIAnchorStyle.Left | UIAnchorStyle.Right;

            button = layoutPanelReset.AddUIComponent<UIButton>();
            button.atlas = ResourceLoader.Atlas;
            button.textScale = Constants.UITextScale;
            button.textPadding = new RectOffset(4, 4, 4, 2);
            ...
            button.text = Translation.Instance.GetTranslation("FOREST-BRUSH-BRUSH-OPTIONS-RESET");
            button.eventClicked += ResetButton_eventClicked;

    ...
    public  class Path 
    {
        public static void Setup(ref UIPanel page)
        {
            ...
            myFastList.rowHeight = 40f;
             FastList<KnotItem> list = new FastList<KnotItem>();
            list.Add(new ControlPoint(new Vector3(1, 1, 1), new Quaternion(0, 0, 0, 1), 60, false));
            list.Add(new ControlPoint(new ControlPoint(new Vector3(0, 2, 5), new Quaternion(0, 0, 0, 1), 60, true));

            myFastList.rowsData = list;

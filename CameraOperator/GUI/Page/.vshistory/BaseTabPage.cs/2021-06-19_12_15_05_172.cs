...
namespace CameraOperatorMod.GUI
{
        ...
        where PlayPanelType : PlaybackPanel
    {
        ...
        public BaseTabPage()
        {
            ...
            ListPanel = AddUIComponent<AdvancedScrollablePanel>();
            ListPanel.Content.autoLayoutPadding = new RectOffset(10, 10, 0, 0);
            ListPanel.atlas = TextureHelper.InGameAtlas;
            ListPanel.backgroundSprite = "UnlockingItemBackground";
            ListPanel.name = nameof(ContentPanel);

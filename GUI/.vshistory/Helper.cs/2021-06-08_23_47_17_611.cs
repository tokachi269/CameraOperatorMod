...
namespace CameraOperatorMod.GUI
{
    public static class Helper
    {
        ...
        public static UIButton AddButton(ref UIPanel parent, string label, string tooltip = "", RectOffset padding = null, Color32? color = null, MouseEventHandler eventClicked)
        {

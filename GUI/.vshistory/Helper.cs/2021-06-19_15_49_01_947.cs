...
namespace CameraOperatorMod.GUI
{
    public static class Helper
    {
        ...
        public static UILabel AddLabel(string label, string tooltip = "",  RectOffset padding = null, Color32? color = null, string bullet = null)
        {
        ...
        public static UICheckBox AddCheckBox(string label, string tooltip, bool initialValue, PropertyChangedEventHandler<bool> onCheckChanged, UIFont font = null, int? indentPadding = null)
        {
            var box = AddUIComponent<UICheckBox>();

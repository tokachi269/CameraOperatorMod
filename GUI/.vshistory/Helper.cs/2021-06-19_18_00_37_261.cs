...
namespace CameraOperatorMod.GUI
{
    public static class Helper
    {
        ...
        public static UILabel AddLabel(UIPanel parent, string label, string tooltip = "",  RectOffset padding = null, Color32? color = null, string bullet = null)
        {
        ...
        public static UICheckBox AddCheckBox(UIPanel parent, string label, string tooltip, bool initialValue, PropertyChangedEventHandler<bool> onCheckChanged, UIFont font = null, int? indentPadding = null)
        {
        ...
        public static SliderPane AddSliderPane<T>(UIPanel parent, SliderOption<T> opts, UIFont font = null)
        {
        ...
        public static UIButton AddButton(UIPanel parent, string label, MouseEventHandler eventClicked, string tooltip = "", RectOffset padding = null, Color32? color = null)
        {

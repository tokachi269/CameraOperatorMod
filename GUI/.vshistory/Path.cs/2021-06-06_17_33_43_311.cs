...
{
    public  class Path : BaseTabPage<AdvancedScrollablePanel>
    {
        public static void Setup(ref UIPanel page)
        {
            ...
            page.tooltip = "Path Base Panel";
            {
                ...
                AddKnot();
                AddKnot();
                AddKnot(new Vector3(0, 2, 5), new Quaternion(0, 0, 0, 1), 60, true);
                AddKnot(new Vector3(0, -2, 1), new Quaternion(0, 0, 0, 1), 60, false);

...
namespace CameraOperatorMod.GUI
{
    ...
    internal abstract class ToolBase : UIPanel, ITool
    {
		...
		{
			Window = UIView.GetAView().AddUIComponent(typeof(CameraOperatorButton)) as CameraOperator;
		}
		...
		{
			Window.size = new Vector2(SupportTool.DefaultRect.width, SupportTool.DefaultRect.height);

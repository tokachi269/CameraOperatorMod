...
namespace CameraOperatorMod.GUI
{
    public abstract class BaseTabPage : UIPanel
    {
        ...
        awake() {
            ...
            height = height - tabStrip.height;

        };
        autoSize = false;public virtual void Render(RenderManager.CameraInfo cameraInfo) { }
        width = tabStrip.width;//public virtual bool OnShortcut(Event e) => false;
        height = height - tabStrip.height;public virtual bool OnEscape() => false;
    }

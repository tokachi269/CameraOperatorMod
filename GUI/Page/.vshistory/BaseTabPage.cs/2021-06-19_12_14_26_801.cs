...
namespace CameraOperatorMod.GUI
{
        ...
        where PlayPanelType : PlaybackPanel
    {
        ...
        public BaseTabPage()
        {
            ...
            CameraSettingPanel = AddUIComponent<ItemsPanelType>();
            CameraSettingPanel.atlas = TextureHelper.InGameAtlas;
            CameraSettingPanel.backgroundSprite = "ScrollbarTrack";
            CameraSettingPanel.name = nameof(ItemsPanel);
            CameraSettingPanel.Init(this);
            CameraSettingPanel.OnSelectClick += OnItemSelect;
            CameraSettingPanel.OnDeleteClick += OnItemDelete;
